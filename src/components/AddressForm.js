  ...
  return (
    <div>
      ...
      <form className="reservationForm p-6 m-10 max-w-5xl h-fit mx-auto">
        ...
        <h2 className="mt-2 mb-4 mx-auto fw-bold text-[25px]">
          Shipping Address
        </h2>
          ...
          <div className="relative z-0 w-full mb-6 group">
            <div class="flex items-center mb-4">
              ...
              <label for="checkbox-3" class="ml-2 text-sm ">
                I wish to receive special offers via email and text
              </label>
            </div>
            <div class="flex items-center mb-4">
              <input id="checkbox-3" type="checkbox" value="" />
        ...
        <div className="flex justify-end ">
          <Link to="/cart">
            <button class="btn-40">
              <span class="new">REVIEW ORDER</span>
              <span class="old">BACK</span>
            </button>
          </Link>
          <Link to="/pay">
            <button class="btn-40">
              <span class="new">PLACE ORDER</span>
              <span class="old">NEXT</span>
            </button>
          </Link>
        </div>
      </form>
